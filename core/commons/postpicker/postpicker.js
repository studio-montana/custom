...
(function($) {
	$.postpicker = function(element, options) {
		...
		plugin.init = function() {
			// wrapper
			$body.append('<div id="postpicker" class="custom-modal-box" style="display: none;"></div>');
			$picker = $("#postpicker");
		...
		plugin.update_interface = function() {
			$picker.empty();
			// close button
			$picker.append('<div id="postpicker-close" class="custom-modal-box-close"><i class="fa fa-times"></i></div>');
			$pickerclose = $("#postpicker-close");
			$pickerclose.on('click', function(e) {
				plugin.close();
			});
			// content
			$picker.append('<div id="postpicker-content" class="custom-modal-box-content"></div>');
			...
			// footer
			$picker.append('<div id="postpicker-footer" class="custom-modal-box-footer"></div>');
