<table>
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-title'); ?>"><?php _e('Title', CUSTOM_TEXT_DOMAIN); ?> : </label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-facebook-url'); ?>"><i class="fa fa-facebook"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-twitter-url'); ?>"><i class="fa fa-twitter"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-googleplus-url'); ?>"><i class="fa fa-google-plus"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-linkedin-url'); ?>"><i class="fa fa-linkedin"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-behance-url'); ?>"><i class="fa fa-behance"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-pinterest-url'); ?>"><i class="fa fa-pinterest-p"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-instagram-url'); ?>"><i class="fa fa-instagram"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-vimeo-url'); ?>"><i class="fa fa-vimeo"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-youtube-url'); ?>"><i class="fa fa-youtube-play"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-dribbble-url'); ?>"><i class="fa fa-dribbble"></i></label></td>
		...
		<tr>
		<td><label for="<?php echo $this->get_field_id('social-tumblr-url'); ?>"><i class="fa fa-tumblr"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-flickr-url'); ?>"><i class="fa fa-flickr"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-soundcloud-url'); ?>"><i class="fa fa-soundcloud"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-mail-url'); ?>"><i class="fa fa-envelope"></i></label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('social-download-url'); ?>"><i class="fa fa-download"></i></label></td>
	...
	<tr>
		<td><input type="checkbox" class="backgrounded-check" name="<?php echo $this->get_field_name('social-backgrounded'); ?>" id="<?php echo $this->get_field_id('social-backgrounded'); ?>"<?php if (!empty($backgrounded) && $backgrounded == 'on'){ echo ' checked="checked"'; } ?> /></td>
