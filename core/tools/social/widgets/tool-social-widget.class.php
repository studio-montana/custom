...
class tool_social_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
				...
				__("Social", CUSTOM_PLUGIN_TEXT_DOMAIN),

				// Widget description
				array('description' => __("Show socials links", CUSTOM_PLUGIN_TEXT_DOMAIN),)
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$template = locate_ressource(CUSTOM_PLUGIN_TOOLS_FOLDER.SOCIAL_TOOL_NAME.'/widgets/templates/tool-social-widget-output.php');
		if (!empty($template))
			include($template);
	...
	public function form( $instance ) {
		...
		// Widget admin form
		$template = locate_ressource('/'.CUSTOM_PLUGIN_TOOLS_FOLDER.SOCIAL_TOOL_NAME.'/widgets/templates/tool-social-widget-form.php');
		if (!empty($template))
			include($template);
	}
