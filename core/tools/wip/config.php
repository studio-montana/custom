...
function tool_wip_get_config_options_section_description(){
	...
	printf( '%s, <a class="field-info" href="'.esc_url(get_admin_url(null, 'customize.php')).'">%s</a>', __("close your site for maintenance or update. Customize wip page appearence", CUSTOM_PLUGIN_TEXT_DOMAIN), __("manage here ", CUSTOM_PLUGIN_TEXT_DOMAIN));
	echo '</p>';
}
