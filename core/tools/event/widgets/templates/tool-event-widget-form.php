...
<table>
	<tr>
		<td><label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title', CUSTOM_PLUGIN_TEXT_DOMAIN); ?> : </label></td>
	...
	<tr>
		<td><label for="<?php echo $this->get_field_id('nb'); ?>"><?php _e('Number', CUSTOM_PLUGIN_TEXT_DOMAIN); ?> : </label></td>
