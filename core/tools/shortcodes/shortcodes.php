 ...
 * REQUIREMENTS
 */
require_once (CUSTOM_PLUGIN_PATH.'/'.CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/exergue/exergue.php');
require_once (CUSTOM_PLUGIN_PATH.'/'.CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/heightspace/heightspace.php');
require_once (CUSTOM_PLUGIN_PATH.'/'.CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/icons/icons.php');
...
function tool_shortcodes_custom_front_enqueue_styles_tools($dependencies) {
	...
	$css_shortcodes = locate_web_ressource(CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/css/tool-shortcodes.css');
...
function tool_shortcodes_custom_admin_enqueue_styles_tools($dependencies) {
	...
	$css_shortcodes = locate_web_ressource(CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/css/tool-shortcodes-admin.css');
	if (!empty($css_shortcodes))
		wp_enqueue_style('tool-shortcodes-css', $css_shortcodes, $dependencies, '1.0');
}
