...
function tool_shortcodes_icons_tiny_mce_plugins($plugins) {
	if (tool_shortcodes_icons_has_permissions() && tool_shortcodes_icons_is_edit_screen()) {
		wp_enqueue_script('tool-shortcodes-script-icons', CUSTOM_PLUGIN_URI.CUSTOM_PLUGIN_TOOLS_FOLDER.SHORTCODES_TOOL_NAME.'/icons/icons.js', array('jquery'), '1.0');
	}
	return $plugins;
}
