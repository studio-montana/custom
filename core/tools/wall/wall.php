 ...
 * REQUIREMENTS
*/
require_once (CUSTOM_PLUGIN_PATH.'/'.CUSTOM_PLUGIN_TOOLS_FOLDER.WALL_TOOL_NAME.'/ajax/wall-ajax.php');
require_once (CUSTOM_PLUGIN_PATH.'/'.CUSTOM_PLUGIN_TOOLS_FOLDER.WALL_TOOL_NAME.'/custom-fields/wall.php');
...
function tool_wall_custom_front_enqueue_styles_tools($dependencies) {
	...
	$css_wall = locate_web_ressource(CUSTOM_PLUGIN_TOOLS_FOLDER.WALL_TOOL_NAME.'/css/tool-wall.css');
	if (!empty($css_wall))
