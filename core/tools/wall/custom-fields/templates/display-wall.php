...
<div id="tool-wall-display-wall" class="custom-fields-section">
	<header class="custom-fields-section-header">
		<h3><?php _e('Wall', CUSTOM_TEXT_DOMAIN); ?></h3>
		<em style="margin-left: 12px;"><?php _e('insert elements in this', CUSTOM_TEXT_DOMAIN); ?> <?php echo $current_post_type_label->singular_name;?></em>
	</header>
	<div class="custom-fields-section-content">
		<table class="fields">
			<tr valign="top">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_POST_TYPE; ?>"><?php _e('Display', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_POST_TYPE; ?>" name="<?php echo META_WALL_DISPLAY_POST_TYPE; ?>">
						<option value="0" <?php if (empty($meta) || $meta == '0'){ echo 'selected="selected"'; }?>><?php _e("nothing", CUSTOM_TEXT_DOMAIN); ?></option>
			...
			<tr valign="top" class="display-wall-options">
				...
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_TERM_SLUG; ?>" name="<?php echo META_WALL_DISPLAY_TERM_SLUG; ?>">
						<option value="0" <?php if (empty($meta) || $meta == '0'){ echo 'selected="selected"'; }?>><?php _e("All", CUSTOM_TEXT_DOMAIN); ?></option>
						<?php 
			...
			<tr valign="top" class="display-wall-options">
				...
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_ORDERBY; ?>" name="<?php echo META_WALL_DISPLAY_ORDERBY; ?>">
						<option value="none" <?php if (!empty($meta) && $meta == 'none'){ echo 'selected="selected"'; }?>><?php _e("no order", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="ID" <?php if (!empty($meta) && $meta == 'ID'){ echo 'selected="selected"'; }?>><?php _e("id", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="author" <?php if (!empty($meta) && $meta == 'author'){ echo 'selected="selected"'; }?>><?php _e("author", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="title" <?php if (!empty($meta) && $meta == 'title'){ echo 'selected="selected"'; }?>><?php _e("title", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="date" <?php if (empty($meta) || $meta == 'date'){ echo 'selected="selected"'; }?>><?php _e("date", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="modified" <?php if (!empty($meta) && $meta == 'modified'){ echo 'selected="selected"'; }?>><?php _e("last modified date", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="rand" <?php if (!empty($meta) && $meta == 'rand'){ echo 'selected="selected"'; }?>><?php _e("random", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="menu_order" <?php if (!empty($meta) && $meta == 'menu_order'){ echo 'selected="selected"'; }?>><?php _e("num. order", CUSTOM_TEXT_DOMAIN); ?></option>
					</select>
				</td>
				<td valign="middle"></td>
				<td valign="middle"></td>
			...
			<tr valign="top" class="display-wall-options">
				...
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_ORDER; ?>" name="<?php echo META_WALL_DISPLAY_ORDER; ?>">
						<option value="DESC" <?php if (empty($meta) || $meta == 'DESC'){ echo 'selected="selected"'; }?>><?php _e("descendant", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="ASC" <?php if (!empty($meta) && $meta == 'ASC'){ echo 'selected="selected"'; }?>><?php _e("ascendant", CUSTOM_TEXT_DOMAIN); ?></option>
					</select>
				</td>
				<td valign="middle"></td>
				<td valign="middle"></td>
			...
			<tr valign="top" class="display-wall-options">
				...
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_PARENT; ?>" name="<?php echo META_WALL_DISPLAY_PARENT; ?>">
						<option value="-1" <?php if (!isset($meta) || $meta == '-1'){ echo 'selected="selected"'; }?>><?php _e("All", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="0" <?php if (isset($meta) && $meta == '0'){ echo 'selected="selected"'; }?>><?php _e("First level", CUSTOM_TEXT_DOMAIN); ?></option>
						<?php
			...
			<tr valign="top" class="display-wall-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_POSITION; ?>">-&nbsp;<?php _e('Position', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					<select id="<?php echo META_WALL_DISPLAY_POSITION; ?>" name="<?php echo META_WALL_DISPLAY_POSITION; ?>">
						<option value="after-content" <?php if (empty($meta) || $meta == 'after-content'){ echo 'selected="selected"'; }?>><?php _e("after content", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="before-content" <?php if (!empty($meta) && $meta == 'before-content'){ echo 'selected="selected"'; }?>><?php _e("before content", CUSTOM_TEXT_DOMAIN); ?></option>
					</select>
				</td>
				<td valign="middle"></td>
				<td valign="middle"></td>
			...
			<tr valign="top" class="display-wall-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION; ?>">-&nbsp;<?php _e('Presentation', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_PRESENTATION; ?>" name="<?php echo META_WALL_DISPLAY_PRESENTATION; ?>">
						...
						<option value="list" <?php if (!empty($meta) && $meta == 'list'){ echo 'selected="selected"'; }?>><?php _e("list", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="isotope" <?php if (!empty($meta) && $meta == 'isotope'){ echo 'selected="selected"'; }?>><?php _e("grid", CUSTOM_TEXT_DOMAIN); ?></option>
					</select>
				</td>
				<td valign="middle"></td>
				<td valign="middle"></td>
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-isotope-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_COLUMNS; ?>">-&nbsp;<?php _e('Columns', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_PRESENTATION_COLUMNS; ?>" name="<?php echo META_WALL_DISPLAY_PRESENTATION_COLUMNS; ?>">
						<option value="1" <?php if (!empty($meta) && $meta == '1'){ echo 'selected="selected"'; }?>><?php _e("1", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="2" <?php if (!empty($meta) && $meta == '2'){ echo 'selected="selected"'; }?>><?php _e("2", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="3" <?php if (empty($meta) || $meta == '3'){ echo 'selected="selected"'; }?>><?php _e("3", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="4" <?php if (!empty($meta) && $meta == '4'){ echo 'selected="selected"'; }?>><?php _e("4", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="5" <?php if (!empty($meta) && $meta == '5'){ echo 'selected="selected"'; }?>><?php _e("5", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="6" <?php if (!empty($meta) && $meta == '6'){ echo 'selected="selected"'; }?>><?php _e("6", CUSTOM_TEXT_DOMAIN); ?></option>
					</select>
				</td>
				<td valign="middle"></td>
				<td valign="middle"></td>
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-masonry-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_MASONRY_WIDTH; ?>">-&nbsp;<?php _e('Max width', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					<select class="wall-update-presentation-setup" id="<?php echo META_WALL_DISPLAY_PRESENTATION_MASONRY_WIDTH; ?>" name="<?php echo META_WALL_DISPLAY_PRESENTATION_MASONRY_WIDTH; ?>">
						<option value="1" <?php if (empty($meta) && $meta == '1'){ echo 'selected="selected"'; }?>><?php _e("100%", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="2" <?php if (!empty($meta) && $meta == '2'){ echo 'selected="selected"'; }?>><?php _e("50%", CUSTOM_TEXT_DOMAIN); ?></option>
						<option value="3" <?php if (!empty($meta) && $meta == '3'){ echo 'selected="selected"'; }?>><?php _e("33%", CUSTOM_TEXT_DOMAIN); ?></option>
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-masonry-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_MASONRY_HEIGHT; ?>">-&nbsp;<?php _e('Max height', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
					...
					if (empty($meta) || !is_numeric($meta))
						$meta = "";
					?>
					<input type="checkbox" class="wall-update-presentation-setup" id="display-wall-masonry-auto-height" <?php if (empty($meta)){ echo ' checked="checked"'; } ?> />&nbsp;<label for="display-wall-masonry-auto-height"><?php _e("Auto", CUSTOM_TEXT_DOMAIN); ?></label>
				</td>
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-masonry-options display-wall-isotope-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_FILTERING; ?>">-&nbsp;<?php _e('Display filters', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_AUTOPLAY; ?>">-&nbsp;<?php _e('Autoplay', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options display-wall-slider-options-thumb-nav">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_THUMB_NAV; ?>">-&nbsp;<?php _e('Thumb navigation', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_CAROUSEL; ?>">-&nbsp;<?php _e('Carousel', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options display-wall-slider-options-carousel">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_CAROUSEL_COLUMNS; ?>">-&nbsp;<?php _e('Carousel columns', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options display-wall-slider-options-carousel">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_CAROUSEL_ITEM_WIDTH; ?>">-&nbsp;<?php _e('Carousel item width', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
			...
			<tr valign="top" class="display-wall-options display-wall-specific-options display-wall-slider-options display-wall-slider-options-carousel">
				<th class="metabox_label_column" align="left" valign="middle"><label
					for="<?php echo META_WALL_DISPLAY_PRESENTATION_SLIDER_CAROUSEL_ITEM_MARGIN; ?>">-&nbsp;<?php _e('Carousel item margin', CUSTOM_TEXT_DOMAIN); ?> : </label>
				</th>
				<td valign="middle">
