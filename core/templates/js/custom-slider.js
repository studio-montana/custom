...
(function($) {
	$.custom_slider_thumb_nav = function(element, options) {
		var plugin = this;
		var $plugin = element;
	...
	$.fn.custom_slider_thumb_nav = function(options) {
		return this.each(function() {
			if (!isset($(this).data('custom_slider_thumb_nav'))) {
				var plugin = new $.custom_slider_thumb_nav($(this), options);
				$(this).data('custom_slider_thumb_nav', plugin);
			} else {
				$(this).data('custom_slider_thumb_nav').resize();
			}
		});
	};
